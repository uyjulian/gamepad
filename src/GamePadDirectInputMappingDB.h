...
enum KeyMapResult {
	KMR_NotFound = 0,
	KMR_SuccessProductMapping,	//!< メーカーと製品の両方が合致するものが見付かった
	KMR_SuccessVenderMapping,	//!< メーカーのみ一致するものが見付かった
	KMR_EOT
};


int CopyKeyMap( struct DirectInputObjectMappingTable& map, unsigned short vender, unsigned short product );
